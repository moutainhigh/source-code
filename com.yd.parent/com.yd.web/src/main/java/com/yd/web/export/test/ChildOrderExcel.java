 ...
 **/
@ExcelTarget("childOrderExcel")
public class ChildOrderExcel implements Serializable {
    ...
    @ExcelCollection(name = "子订单商品信息")
    private List<ChildOrderDetailExcel> detailList;
    ...
    public List<ChildOrderDetailExcel> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<ChildOrderDetailExcel> detailList) {
