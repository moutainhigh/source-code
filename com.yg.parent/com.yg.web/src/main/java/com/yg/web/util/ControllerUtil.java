...
public class ControllerUtil {
	...
	public static final String	COOKIE_CLIENT_NAME	= PropertiesHelp.getProperty("admin.cookie.client.name");
	public static final String	COOKIE_PASSPORT_NAME	= PropertiesHelp.getProperty("admin.cookie.passport.name");
	public static final String	COOKIE_DOMAIN			= PropertiesHelp.getProperty("admin.cookie.domain");
